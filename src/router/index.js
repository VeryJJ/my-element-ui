    ...
    children: [
      {
        ...
        meta: { title: 'cmdb-真线', icon: 'table' }
      },
      {
        path: 'cmdb-上海',
        name: 'cmdb-shanghai',
        component: () => import('@/views/cmdb/app/index-shanghai'),
        meta: { title: 'cmdb-上海', icon: 'table' }
      }
    ]
  },
    ...
    children: [
      {
        path: 'index',
        name: 'paas-success',
        component: () => import('@/views/paas-success/index'),
        meta: { title: 'paas-success', icon: 'form' }
      }
    ]
  },
